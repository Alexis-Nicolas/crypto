...
import iutdijon.cryptomessengerclient.controleur.protocoles.GenerateurCle;
...
public class ControleurGenerationCleSymetrique extends Controleur {
    ...
    public void avertir() {
        switch(protocole) {
            case CESAR:  
                ecran.setCle(GenerateurCle.genererCleCesar());  
            break;
            case SUBSTITUTION:  
                ecran.setCle(GenerateurCle.genererCleSubstitution());  
            break;
            case TRANSPOSITION:
                ecran.setCle(GenerateurCle.genererCleTransposition());
            break;
            case VIGENERE:
                ecran.setCle(GenerateurCle.genererCleVigenere());
            break;
